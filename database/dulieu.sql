...
('2 MIẾNG GÀ GIÒN VUI VẺ', 'gagionvuive1.jpg', 1), -- MaMonAn = 1
('4 MIẾNG GÀ GIÒN VUI VẺ', 'gagionvuive2.jpg', 1), -- MaMonAn = 2
('6 MIẾNG GÀ GIÒN VUI VẺ', 'gagionvuive3.jpg', 1), -- MaMonAn = 3
('2 GÀ GIÒN VUI VẺ + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'gagionvuive4.jpg', 1), -- MaMonAn = 4
('1 GÀ GIÒN VUI VẺ + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'gagionvuive5.jpg', 1), -- MaMonAn = 5
('1 CƠM GÀ GIÒN VUI VẺ + 1 SÚP BÍ ĐỎ + 1 NƯỚC NGỌT', 'gagionvuive6.jpg', 1), -- MaMonAn = 6
('1 CƠM GÀ GIÒN VUI VẺ + 1 NƯỚC NGỌT + 1 TƯƠNG CHUA NGỌT', 'gagionvuive7.jpg', 1), -- MaMonAn = 7
('1 CƠM GÀ GIÒN VUI VẺ', 'gagionvuive8.jpg', 1), -- MaMonAn = 8
('1 MIẾNG GÀ GIÒN VUI VẺ', 'gagionvuive9.jpg', 1), -- MaMonAn = 9

-- Loai 2: Mì ý (9 món)
('MÌ Ý SỐT CAY VỪA', 'miy1.jpg', 2), -- MaMonAn = 10
('1 MÌ Ý SỐT CAY VỪA + 1 NƯỚC NGỌT', 'miy2.jpg', 2), -- MaMonAn = 11
('MÌ Ý SỐT CAY VỪA + 1 GÀ GIÒN VUI VẺ + 1 NƯỚC NGỌT', 'miy3.jpg', 2), -- MaMonAn = 12
('1 MÌ Ý JOLLY VỪA + 1 GÀ GIÒN VUI VẺ + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'miy4.jpg', 2), -- MaMonAn = 13
('1 MÌ Ý JOLLY VỪA + 2 GÀ KHÔNG XƯƠNG + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'miy5.jpg', 2), -- MaMonAn = 14
('1 GÀ GIÒN VUI VẺ + 1 MÌ Ý JOLLY + 1 NƯỚC NGỌT', 'miy6.jpg', 2), -- MaMonAn = 15
('1 MÌ Ý JOLLY VỪA + 2 GÀ KHÔNG XƯƠNG + 1 NƯỚC NGỌT', 'miy7.jpg', 2), -- MaMonAn = 16
('1 MÌ Ý JOLLY VỪA + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'miy8.jpg', 2), -- MaMonAn = 17
('1 MÌ Ý JOLLY VỪA + 1 NƯỚC NGỌT', 'miy9.jpg', 2), -- MaMonAn = 18

-- Loai 3: Gà sốt (9 món)
('2 MIẾNG GÀ SỐT CAY', 'gasot1.jpg', 3), -- MaMonAn = 19
('2 GÀ SỐT CAY + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'gasot2.jpg', 3), -- MaMonAn = 20
('1 GÀ SỐT CAY + 1 KHOAI TAY CHIÊN VỪA + 1 NƯỚC NGỌT', 'gasot3.jpg', 3), -- MaMonAn = 21
('1 COM GÀ SỐT CAY + 1 SÚP BÍ ĐỎ + 1 NƯỚC NGỌT', 'gasot4.jpg', 3), -- MaMonAn = 22
('1 GÀ SỐT CAY + 1 NƯỚC NGỌT', 'gasot5.jpg', 3), -- MaMonAn = 23
('1 CƠM GÀ SỐT CAY', 'gasot6.jpg', 3), -- MaMonAn = 24
('1 MIẾNG GÀ SỐT CAY', 'gasot7.jpg', 3), -- MaMonAn = 25

-- Loai 4: Burger (7 món)
('CƠM GÀ MẮM TỎI', 'burger1.jpg', 4), -- MaMonAn = 26
('1 CƠM GÀ MẮM TỎI + 1 NƯỚC NGỌT', 'burger2.jpg', 4), -- MaMonAn = 27
('1 BURGER TÔM + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'burger3.jpg', 4), -- MaMonAn = 28
('1 BURGER TÔM + 1 NƯỚC NGỌT', 'burger4.jpg', 4), -- MaMonAn = 29
('1 JOLLY HOTDOG + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'burger5.jpg', 4), -- MaMonAn = 30
('1 JOLLY HOTDOG + 1 NƯỚC NGỌT', 'burger6.jpg', 4), -- MaMonAn = 31
('1 SANDWICH GÀ GIÒN + 1 KHOAI TÂY CHIÊN VỪA + 1 NƯỚC NGỌT', 'burger7.jpg', 4), -- MaMonAn = 32
('1 SANDWICH GÀ GIÒN + 1 NƯỚC NGỌT', 'burger8.jpg', 4), -- MaMonAn = 33
('BURGER TÔM', 'burger9.jpg', 4), -- MaMonAn = 34

-- Loai 5: Tráng miệng (6 món)
('BÁNH XOÀI ĐÀO', 'trangmieng1.jpg', 5), -- MaMonAn = 35
('TROPICAL SUNDAE', 'trangmieng2.jpg', 5), -- MaMonAn = 36
('KEM SUNDAE DÂU', 'trangmieng3.jpg', 5), -- MaMonAn = 37
('KEM SUNDAE SOCOLA', 'trangmieng4.jpg', 5), -- MaMonAn = 38
('KEM SÔCÔLA', 'trangmieng5.jpg', 5), -- MaMonAn = 39
('KEM SỮA TƯƠI', 'trangmieng6.jpg', 5), -- MaMonAn = 40

-- Loai 6: Nước (6 món)
('TRÀ CHANH HẠT CHIA', 'nuoc1.jpg', 6), -- MaMonAn = 41
('NƯỚC ÉP XOÀI ĐÀO', 'nuoc2.jpg', 6), -- MaMonAn = 42
('PEPSI', 'nuoc3.jpg', 6), -- MaMonAn = 43
('MIRINDA', 'nuoc5.jpg', 6), -- MaMonAn = 44
('7UP', 'nuoc7.jpg', 6), -- MaMonAn = 45
('CACAO', 'nuoc9.jpg', 6); -- MaMonAn = 46
