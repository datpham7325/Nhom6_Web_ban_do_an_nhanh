...
<body>
  ...
  <div class="register-container">
    ...
    <form method="POST" action="" class="register-form" id="registerForm">
      <table class="form-table">
        ...
        <tr>
          <td><input type="submit" value="Đăng ký" name="btnsend" class="btn-register" id="btnRegister"></td>
  ...
  <!-- Success Modal -->
  <div id="successModal" class="modal <?php echo $showSuccessModal ? 'show' : ''; ?>">
    <div class="modal-content">
      <div class="modal-icon">✅</div>
      <h2 class="modal-title">Đăng Ký Thành Công!</h2>
      <p class="modal-message">Tài khoản của bạn đã được tạo thành công. Bạn sẽ được chuyển đến trang đăng nhập.</p>
      <button class="modal-button" onclick="redirectToLogin()">Đồng Ý</button>
    </div>
  </div>
